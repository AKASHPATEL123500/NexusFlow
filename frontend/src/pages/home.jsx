...
function Home() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/4 left-1/4 w-[600px] h-[600px] bg-amber-500/10 rounded-full blur-[150px] animate-float-1" />
      <div className="absolute bottom-1/4 right-1/3 w-[500px] h-[500px] bg-orange-400/10 rounded-full blur-[130px] animate-float-2" />
      <div className="absolute top-1/2 right-1/4 w-[400px] h-[400px] bg-yellow-400/10 rounded-full blur-[120px] animate-float-3" />
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden opacity-[0.08]">
        {[...Array(25)].map((_, i) => (
          <div
            key={i}
            className="absolute h-[2px] bg-gradient-to-r from-transparent via-amber-400 to-transparent animate-diagonal-flow"
            style={{
              width: '200%',
              top: `${i * 4}%`,
              left: '-50%',
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-20">
        ...
        <div className="absolute top-8 right-8 group">
          ...
          <div className="h-px w-0 bg-gradient-to-r from-amber-400/50 to-transparent group-hover:w-full transition-all duration-500 mt-1" />
        </div>
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative w-12 h-12">
                <div className="absolute inset-0 bg-gradient-to-br from-amber-400 to-orange-500 opacity-20 blur-xl animate-pulse" />
        ...
        <div className="max-w-5xl text-center space-y-10">
          ...
          <div className="relative">
            <h1 className="text-7xl md:text-9xl font-black tracking-tighter relative leading-none">
              ...
              <span className="relative bg-gradient-to-b from-white via-amber-50 to-amber-400 bg-clip-text text-transparent filter drop-shadow-[0_0_30px_rgba(251,191,36,0.3)]">
                NEXUSFLOW
              </span>
            </h1>
            ...
            <div className="flex justify-center mt-6">
              <div className="h-[2px] w-64 bg-gradient-to-r from-transparent via-amber-400 to-transparent animate-width-pulse" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-12 pt-16 max-w-3xl mx-auto">
            {[
              ...
              >
                <div className="absolute -inset-4 bg-gradient-to-br from-amber-400/0 to-orange-400/0 group-hover:from-amber-400/5 group-hover:to-orange-400/5 rounded-lg blur-xl transition-all duration-500" />
                <div className="relative border border-white/5 rounded-lg p-6 bg-white/[0.02] backdrop-blur-sm group-hover:border-amber-400/20 transition-all duration-500 group-hover:transform group-hover:scale-105">
                  <div className="text-5xl font-bold bg-gradient-to-br from-amber-400/40 to-orange-400/40 bg-clip-text text-transparent group-hover:from-amber-400/70 group-hover:to-orange-400/70 transition-all duration-500">
                    {item.num}
                  </div>
          ...
          <div className="pt-20 space-y-8">
            <div className="inline-block relative group">
              <div className="absolute -inset-2 bg-gradient-to-r from-amber-400 via-orange-500 to-amber-400 rounded-xl blur-lg opacity-40 group-hover:opacity-70 transition-all duration-700 animate-gradient-shift" />
              <div className="absolute -inset-1 bg-gradient-to-r from-amber-400 to-orange-500 rounded-lg opacity-50 group-hover:opacity-80 transition-all duration-500" />
            ...
            <div className="flex items-center justify-center gap-6 text-white/40 text-xs">
              <div className="h-px w-20 bg-gradient-to-r from-transparent via-amber-400/30 to-amber-400/30 animate-line-glow" />
              <span className="tracking-[0.6em] font-light">2 0 2 6</span>
              <div className="h-px w-20 bg-gradient-to-l from-transparent via-amber-400/30 to-amber-400/30 animate-line-glow-reverse" />
            </div>
            ...
            <div className="flex flex-wrap gap-3 justify-center pt-4">
              {['AI-Powered', 'Cloud Native', 'Real-time Sync', 'Enterprise Ready'].map((feature, idx) => (
                <div 
                  key={idx}
                  className="px-4 py-2 rounded-full border border-white/10 bg-white/[0.02] backdrop-blur-sm text-white/40 text-xs tracking-wider hover:border-amber-400/30 hover:text-amber-400/60 transition-all duration-500 cursor-default animate-fade-in-premium"
        ...
        <div className="absolute bottom-8 left-0 right-0 flex justify-between items-center px-8 text-white/20 text-[10px] tracking-[0.3em]">
          ...
          <div className="group cursor-default">
            ...
            <div className="h-px w-0 bg-gradient-to-l from-amber-400/50 to-transparent group-hover:w-full transition-all duration-500 mt-1" />
          </div>
        </div>
        ...
        <div className="absolute bottom-24 left-1/2 -translate-x-1/2 animate-bounce-premium">
          <div className="relative group">
            ...
            <div className="relative w-7 h-12 border-2 border-amber-400/30 rounded-full flex items-start justify-center p-1.5 group-hover:border-amber-400/60 transition-all duration-500">
              <div className="w-1.5 h-3 bg-gradient-to-b from-amber-400/60 to-transparent rounded-full animate-scroll-premium" />
            </div>
          </div>
        </div>
      </div>
